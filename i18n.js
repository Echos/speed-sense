...
const TRANSLATIONS = {
  ja: {
    ...
    'label-overlay-speed-reset':     '速度リセット時',
    'label-overlay-speed-reset-sub': '1.0x 中に表示',
    'kb-speed-up':           '通常速度 +',
    'kb-speed-down':         '通常速度 −',
    'kb-toggle':             'ON/OFF 切替',
  ...
  en: {
    ...
    'label-overlay-speed-reset':     'On Speed Reset',
    'label-overlay-speed-reset-sub': 'show at 1.0x',
    'kb-speed-up':           'Speed +',
    'kb-speed-down':         'Speed −',
